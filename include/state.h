...
typedef enum {BALL, PLATFORM, POKEMON, MASTERBALL} ObjectType;

typedef enum {IDLE, JUMPING, FALLING, MOVING_UP, MOVING_DOWN} VerticalMovement;

typedef enum {STARYU, STARMIE, BULBASAUR, CHARMANDER, PICACHU, ZEKROM, RESHIRAM, ARCEUS, REYQUAZA, TORTERRA, SNORLAX, SQUIRTLE, EEVEE, GENGAR, NOTHING} Pokemon;
